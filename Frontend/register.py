# use doc string to make this code attractive this task
from tkinter import *
...
class Register():
    def __init__(self, root):
        ...
        # === Left Image====
        self.left = ImageTk.PhotoImage(file="images/sensors.jpg")  # if .png image is available
        ...
        self.login_btn = Button(frame1, text="Sign In", font=("times new roman", 14, "bold"), bg="white", fg="blue",
                                bd="5", cursor="hand2").place(x=370, y=410, width=250)
