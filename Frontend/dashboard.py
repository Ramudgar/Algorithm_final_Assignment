...
class Bill_app:
    def __init__(self,bill):
     ...
     #======== customer details frame
        F1=LabelFrame(self.bill,text='Customer Details',bd=10,relief=GROOVE,font=('times new roman',15,'bold'),fg='gold',bg=bg_color)
        F1.place(x=0,y=80,relwidth=1)
        cname_lbl=Label(F1,text='Customer Name',font=('times new roman',18,'bold')).grid(row=0,column=0,padx=20,pady=5)
        cname_txt=Entry(F1,textvariable=self.c_name,width=15,bd=7,relief=SUNKEN,font='arial 15').grid(row=0,column=1,padx=10,pady=5)

        cphn_lbl=Label(F1,text='Customer phone no.',font=('times new roman',18,'bold')).grid(row=0,column=2,padx=20,pady=5)
        cphn_txt=Entry(F1,textvariable=self.c_phone,width=15,bd=7,relief=SUNKEN,font='arial 15').grid(row=0,column=3,padx=10,pady=5)

        c_bill_lbl=Label(F1,text='Bill number',font=('times new roman',18,'bold')).grid(row=0,column=4,padx=20,pady=5)
        c_bill_txt=Entry(F1,textvariable=self.search_bill,width=15,bd=7,relief=SUNKEN,font='arial 15').grid(row=0,column=5,padx=10,
        pady=5)

        bill_btn =Button (F1,text="search",command=self.find_bill,width=10,bd=7,font='arial 12 bold').grid(row=0 ,
        column=6,padx=10,pady=10)


        #=========FAST_FOOD FRAME========
        F2=LabelFrame(self.bill,bd=10,relief=GROOVE,text='Fast_foods',font=('times new roman' ,15,'bold'),bg=bg_color,fg='gold')
        F2.place(x=5,y=170,width=325,height=360)

        chaumin_lbl=Label(F2,text='Chaumin',font=('times new roman',16,'bold'),bg=bg_color,fg='light green').grid(row=0,
        column=0,padx=10,pady=10,sticky='w')
        chaumin_lbl=Entry(F2,width=10,textvariable=self.chaumin,font=('times new roman',16,'bold'),bd=5,relief=SUNKEN,).grid(column=1,
        row=0,padx=10,pady=10)
        momo_lbl=Label(F2,text='Fried_Momo',font=('times new roman',16,'bold'),bg=bg_color,fg='light green').grid(row=1,
        column=0,padx=10,pady=10,sticky='w')
        momo_lbl=Entry(F2,width=10,textvariable=self.momo,font=('times new roman',16,'bold'),bd=5,relief=SUNKEN).grid(column=1,
        row=1,padx=10,pady=10)
        mushroom_lbl=Label(F2,text='Mushroom_sauce',font=('times new roman',16,'bold'),bg=bg_color,fg='light green').grid(row=2,
        column=0,padx=10,pady=10,sticky='w')
        mushroom_lbl=Entry(F2,width=10,textvariable=self.mushroom,
        font=('times new roman',16,'bold'),bd=5,relief=SUNKEN,).grid(column=1,row=2,padx=10,pady=10)
        ...
        font=('times new roman',16,'bold'),bd=5,relief=SUNKEN).grid(column=1,row=5,padx=10,pady=10)
        ...
        font=('times new roman',16,'bold'),bd=5,relief=SUNKEN).grid(row=0,column=1,padx=10,pady=10)
        ...
        bd=5,relief=SUNKEN).grid(row=5,column=1,padx=10,pady=10)
            ...
            ##Dinner items=====
        F4=LabelFrame(self.bill,bd=10,relief=GROOVE,text='Dinner Items',font=('ties new roman',14,'bold'),bg=bg_color,fg='gold')
        ...
        ##==========Button frame=======
        F6=LabelFrame(self.bill,bd=10,relief=GROOVE,text='Bill menu',font=('times',14,'bold'),bg=bg_color,fg='gold')
        ...
        font=('arial 10 bold'),bg='cadetblue',fg='white',bd=2,relief=GROOVE,pady=15).grid(row=0,column=0,padx=5,pady=5)
        GBill_btn=Button(btn_f,command=self.bill_area,text='Generate bill',width=11,
        font=('arial 10 bold'),bg='cadetblue',fg='white',bd=2,relief=GROOVE,pady=15).grid(row=0,column=1,padx=5,pady=5)
        ...
        font=('arial 10 bold'),bg='cadetblue',fg='white',bd=2,relief=GROOVE,pady=15).grid(row=0,column=3,padx=5,pady=5)
        self.welcome_bill()
