...
class Bill_app:
    def __init__(self, bill):
        ...
        cname_lbl = Label(F1, text='Customer Name', font=('times new roman', 18, 'bold'))
        cname_lbl   .grid(row=0, column=0, padx=20,pady=5)

        cname_txt = Entry(F1, textvariable=self.c_name, width=15, bd=7, relief=SUNKEN,
                          font='arial 15').grid(row=0, column=1, padx=10, pady=5)

        cphn_lbl = Label(F1, text='Customer phone no.', font=('times new roman', 18, 'bold'))
        cphn_lbl.grid(row=0, column=2,padx=20, pady=5)

        cphn_txt = Entry(F1, textvariable=self.c_phone, width=15, bd=7, relief=SUNKEN, font='arial 15')
        ...
        c_bill_lbl = Label(F1, text='Bill number', font=('times new roman', 18, 'bold')).grid(row=0, column=4, padx=20,
                                                                                              pady=5)
        c_bill_txt = Entry(F1, textvariable=self.search_bill, width=15, bd=7, relief=SUNKEN,
                           font='arial 15')
        ...
        chaumin_ent = Entry(F2, width=10, textvariable=self.chaumin, font=('times new roman', 16, 'bold'), bd=5,
                            relief=SUNKEN, )
        chaumin_ent.grid(column=1, row=0, padx=10, pady=10)
        ...
        momo_ent = Entry(F2, width=10, textvariable=self.momo, font=('times new roman', 16, 'bold'), bd=5,
                         relief=SUNKEN)
        momo_ent    .grid(column=1, row=1, padx=10, pady=10)
        ...
        mushroom_ent = Entry(F2, width=10, textvariable=self.mushroom,
                             font=('times new roman', 16, 'bold'), bd=5, relief=SUNKEN, )
        mushroom_ent .grid(column=1, row=2, padx=10,
                                                                                               pady=10)
        ...
        noodle_ent = Entry(F2, width=10, textvariable=self.noodle, font=('times new roman', 16, 'bold'),
                           bd=5, relief=SUNKEN, )
        noodle_ent  .grid(column=1, row=3, padx=10, pady=10)
        ...
        pastha_ent = Entry(F2, width=10, textvariable=self.pastha, font=('times new roman', 16, 'bold'),
                           bd=5, relief=SUNKEN, )
        pastha_ent.grid(column=1, row=4, padx=10, pady=10)
        ...
        egg_ent = Entry(F2, width=10, textvariable=self.egg,
                        font=('times new roman', 16, 'bold'), bd=5, relief=SUNKEN)
        egg_ent.grid(column=1, row=5, padx=10,pady=10)
        ...
        ice_ent = Entry(F3, width=10, textvariable=self.Ice_cream,
                        font=('times new roman', 16, 'bold'), bd=5, relief=SUNKEN)
        ice_ent.grid(row=0, column=1, padx=10,
                                                                                        pady=10)
        ...
        coc_ent = Entry(F3, width=10, textvariable=self.coca_cola, font=('times new roman', 16, 'bold'),
                        bd=5, relief=SUNKEN)
        coc_ent.grid(row=1, column=1, padx=10, pady=10)

        phnta_lbl = Label(F3, text='Phanta', font=('times new roman', 16, 'bold'), bg=bg_color,
                          fg='light green').grid(row=2, column=0, padx=10, pady=10, sticky='w')

        phnta_ent = Entry(F3, width=10, textvariable=self.phanta, font=('times new roman', 16, 'bold'),
                          bd=5, relief=SUNKEN)
        phnta_ent.grid(row=2, column=1, padx=10, pady=10)
        ...
        swt_ent = Entry(F3, width=10, textvariable=self.sweet, font=('times new roman', 16, 'bold'),
                        bd=5, relief=SUNKEN)
        swt_ent.grid(row=3, column=1, padx=10, pady=10)

        milk_lbl = Label(F3, text='Milk', font=('times new roman', 16, 'bold'),
                         bg=bg_color, fg='light green').grid(row=4, column=0, padx=10, pady=10, sticky='w')

        milk_ent = Entry(F3, width=10, textvariable=self.Milk, font=('times new roman', 16, 'bold'),
                         bd=5, relief=SUNKEN)
        milk_ent.grid(row=4, column=1, padx=10, pady=10)

        curd_lbl = Label(F3, text='Curd', font=('times new roman', 16, 'bold'),
                         bg=bg_color, fg='light green').grid(row=5, column=0, padx=10, pady=10, sticky='w')

        curd_ent = Entry(F3, width=10, textvariable=self.curd, font=('times new roman', 16, 'bold'),
                         bd=5, relief=SUNKEN)
        curd_ent.grid(row=5, column=1, padx=10, pady=10)
        ...
        D1_lbl = Label(F4, text='Chiken_Biryani', font=('times new roman', 16, 'bold'), bg=bg_color,
                       fg='light green').grid(row=0, column=0, padx=10, pady=10, sticky='w')
        D1_ent = Entry(F4, width=10, bd=5, textvariable=self.biryani, relief=SUNKEN,
                       font=('times new roman', 16, 'bold'))
        D1_ent.grid(row=0, column=1, padx=10, pady=10)
        D2_lbl = Label(F4, text='Mutton_Biryani', font=('times new roman', 16, 'bold'), bg=bg_color,
                       fg='light green').grid(row=1, column=0, padx=10, pady=10, sticky='w')
        D2_ent = Entry(F4, width=10, bd=5, textvariable=self.mutton, relief=SUNKEN,
                       font=('times new roman', 16, 'bold'))
        D2_ent.grid(row=1, column=1, padx=10, pady=10)
        ...
        D3_ent = Entry(F4, width=10, bd=5, textvariable=self.rice, relief=SUNKEN,
                       font=('times new roman', 16, 'bold'))
        D3_ent.grid(row=2, column=1, padx=10, pady=10)
        D4_lbl = Label(F4, text='Cooked_Vegetable', font=('times new roman', 16, 'bold'),
                       bg=bg_color, fg='light green').grid(row=3, column=0, padx=10, pady=10, sticky='w')
        D4_ent = Entry(F4, width=10, bd=5, textvariable=self.vegetable, relief=SUNKEN,
                       font=('times new roman', 16, 'bold'))
        D4_ent.grid(row=3, column=1, padx=10, pady=10)
        ...
        D5_ent = Entry(F4, width=10, bd=5, textvariable=self.vegeterian, relief=SUNKEN,
                       font=('times new roman', 16, 'bold'))
        D5_ent.grid(row=4, column=1, padx=10, pady=10)
        ...
        D6_ent = Entry(F4, width=10, bd=5, textvariable=self.andakari, relief=SUNKEN,
                       font=('times new roman', 16, 'bold'))
        D6_ent.grid(row=5, column=1, padx=10, pady=10)
        ...
        m1_ent = Entry(F6, bd=7, textvariable=self.fast_food_price, relief=SUNKEN,
                       font=('arial 10 bold'))
        m1_ent.grid(row=0, column=1, padx=20, pady=2)
        ...
        m2_ent = Entry(F6, bd=7, relief=SUNKEN, textvariable=self.grocery_price,
                       font=('arial 10 bold'))
        m2_ent.grid(row=1, column=1, padx=20, pady=2)
        ...
        m3_ent = Entry(F6, bd=7, relief=SUNKEN, textvariable=self.dinner_price,
                       font=('arial 10 bold'))
        m3_ent.grid(row=2, column=1, padx=20, pady=2)

        c1_lbl = Label(F6, text='Fast_food tax', bg=bg_color, fg='white',
                       font=('times new roman', 15, 'bold')).grid(row=0, column=2, padx=20, pady=2)
        c1_ent = Entry(F6, bd=7, textvariable=self.fast_food_tax, relief=GROOVE,
                       font=('arial 10 bold'))
        c1_ent.grid(row=0, column=3, padx=20, pady=2)
        c2_lbl = Label(F6, text='Grocery tax', bg=bg_color, fg='white',
                       font=('times new roman', 15, 'bold')).grid(row=1, column=2, padx=20, pady=2)
        c2_ent = Entry(F6, bd=7, textvariable=self.grocery_tax, relief=GROOVE,
                       font=('arial 10 bold'))
        c2_ent.grid(row=1, column=3, padx=20, pady=2)
        ...
        c3_ent = Entry(F6, bd=7, textvariable=self.dinner_tax, relief=GROOVE,
                       font=('arial 10 bold'))
        c3_ent.grid(row=2, column=3, padx=20, pady=2)
